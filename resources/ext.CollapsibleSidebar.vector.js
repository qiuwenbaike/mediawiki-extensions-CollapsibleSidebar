...
(function () {
	...
	var IS_COLLAPSED = document.documentElement.classList.contains(
	...
	icon.title = IS_COLLAPSED ?
		message('show-link-tooltip') :
		message('hide-link-tooltip');
	icon.style.left = IS_COLLAPSED ?
		'0.3em' :
		BODY_WIDTH() < 982 ?
			'9.3em' :
			'10.3em';
	...
	var setCookie = function (object) {
		...
		var hour = object.hour || 0;
		var path = object.path || '/';
		var isSecure = object.isSecure || true;

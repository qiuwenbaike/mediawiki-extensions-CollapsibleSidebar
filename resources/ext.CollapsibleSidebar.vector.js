...
(() => {
	...
	const COOKIE_NAME = 'usecollapsedsidebar',
		...
		NEXT_ICON = "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 48 48'%3E%3Cpath fill='%232196f3' d='M17.1 5L14 8.1 29.9 24 14 39.9l3.1 3.1L36 24z'/%3E%3C/svg%3E",
		PREV_ICON = "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 48 48'%3E%3Cpath fill='%232196f3' d='M30.9 43l3.1-3.1L18.1 24 34 8.1 30.9 5 12 24z'/%3E%3C/svg%3E",
		WIKI_LOGO = document.querySelectorAll('.mw-wiki-logo')[ 0 ],
	...
	document.querySelector('#mw-navigation').appendChild(iconLink);
	...
	const switchMode = {
		...
		hide: () => {
			...
			document.querySelector('#sidebarCollapse').src = NEXT_ICON;
			document.querySelector('#sidebarCollapse').style.left = '0.3em';
		},
		show: () => {
			...
			document.querySelector('#sidebarCollapse').src = PREV_ICON;
			document.querySelector('#sidebarCollapse').style.left =
